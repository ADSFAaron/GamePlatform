                    ...
                    <div class="detail-info">
                        ...
                        @if($product->sale_price > 0 && $sale->status == 1 && $sale->sale_date > \Carbon\Carbon::now())
                            <div class="wrap-price">
                                <span class="product-price">NTD {{$product->sale_price}}</span>
                                <del><span class="regprice">NTD {{$product->regular_price}}</span>
                                </del>
                            </div>
                        @else
                            <div class="wrap-price"><span class="product-price">NTD {{$product->regular_price}}</span>
                            </div>
                        @endif
