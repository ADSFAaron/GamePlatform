    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span>Game List</span></li>
            </ul>
        </div>
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                <div class="wrap-shop-control">
                    ...
                    <h1 class="shop-title">Game List</h1>
                    ...
                    <ul class="product-list grid-products equal-container">
                            ...
                            <div class="product product-style-3 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="detail.html" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                        <figure><img src="https://cf.shopee.tw/file/91da3b8c3bae42a7b7576bf73e258146" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                    </a>
                                </div>
                                <div class="product-info">
                                    <a href="#" class="product-name"><span>懷舊電玩 任天堂GC 特攻神諜/潛龍諜影 METAL GEAR SOLID TWIN SNAKES 日版 郵局享免運</span></a>
                                    <div class="wrap-price"><span class="product-price">NTD 250</span></div>
                        ...
                        <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                            <div class="product product-style-3 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="detail.html" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                        <figure><img src="https://b.ecimg.tw/items/DGBJ85A90098III/000001_1533708701.jpg"  alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                    </a>
                                </div>
                                <div class="product-info">
                                    <a href="#" class="product-name"><span>二手 PS4《惡靈古堡 2》中文版</span></a>
                                    <div class="wrap-price"><span class="product-price">NTD 1499</span></div>
                                    <a href="#" class="btn add-to-cart">Buy Now</a>
                                </div>
                            </div>
                        </li>
                ...
                <div class="widget mercado-widget categories-widget">
                    ...
                    <div class="widget-content">
                        <ul class="list-category">
                            ...
                            <li class="category-item has-child-cate">
                                <a href="#" class="cate-link">Game List</a>
                                <span class="toggle-control">+</span>
                                <ul class="sub-cate">
                                    <li class="category-item"><a href="#" class="cate-link">Batteries (22)</a></li>
                                    <li class="category-item"><a href="#" class="cate-link">Headsets (16)</a></li>
