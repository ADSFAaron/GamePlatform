            ...
            <form wire:submit.prevent="placeOrder">
                    ...
                    <div class="col-md-12">
                        <div class="wrap-address-billing">
                            ...
                            <div class="billing-address">
                                ...
                                <p class="row-in-form">
                                    <label for="zip-code">Province<span>*</span></label>
                                    <input type="number" name="province" value="" placeholder="Province"
                                           wire:model="province">
                                    @error('province')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                ...
                <div class="summary summary-checkout">
                    <div class="summary-item payment-method">
                        ...
                        @if(Session::has('checkout'))
                            <p class="summary-info grand-total"><span>Grand Total</span> <span
                                    class="grand-total-price">NTD {{Session::get('checkout')['total']}}</span></p>
                    ...
                    <div class="summary-item shipping-method">
                        ...
                        <p class="summary-info"><span class="title">Fixed NTD 0.00</span></p>
                    </div>
                </div>
            </form>
